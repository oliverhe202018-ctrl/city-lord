...
import { filterDriftPoints, isLoopClosed, calculatePathDistance, validateHumanLimits, LOOP_CLOSURE_THRESHOLD_M, ABSOLUTE_SPEED_LIMIT_KMH, GeoPoint,  } from '@/lib/geometry-utils';

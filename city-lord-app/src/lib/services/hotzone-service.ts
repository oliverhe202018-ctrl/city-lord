...
import { HOT_ZONE_THRESHOLD, HOT_ZONE_WINDOW_DAYS, HOT_ZONE_CAPTURE_MULTIPLIER, NORMAL_CAPTURE_MULTIPLIER, LOSS_PENALTY_RATIO, BASE_SCORE_PER_KM2,  } from '@/lib/constants/territory'

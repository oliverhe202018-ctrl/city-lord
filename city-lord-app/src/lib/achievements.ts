...
import { Footprints, Medal, Hexagon, Crown, Swords, Users, Flame, MapPin, Target, Star, Flag, Award, Eye, Map as MapIcon, Building, Compass, Zap, Wind, Navigation, Trophy, Axe, Skull, Sunrise, Moon, CloudLightning, Sparkles,  } from 'lucide-react'

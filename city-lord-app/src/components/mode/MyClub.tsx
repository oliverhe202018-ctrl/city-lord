  ...
  return (
    <div className="flex items-center gap-3 p-2 rounded-lg bg-zinc-800/50">
      <div className="relative">
        <img src={member.avatarUrl} alt={member.name} width={48} height={48} className="w-12 h-12 rounded-full object-cover bg-zinc-700" />
        {member.isOnline && (
    ...
    <div className="p-4 text-white min-h-[500px] pb-24">
      ...
      <div className="space-y-3">
        {availableClubs.map(club => (
          ...
          >
            <img src={club.avatar} alt={club.name} width={48} height={48} className="w-12 h-12 rounded-full flex-shrink-0 object-cover bg-zinc-700" />

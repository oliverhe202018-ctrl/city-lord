...
import { Trophy, MapPin, Swords, Target, TrendingUp, TrendingDown, Clock, Footprints, Shield } from 'lucide-react';
            ...
            <div className="relative mb-4">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 p-[2px]">
                <div className="w-full h-full rounded-full bg-zinc-900 flex items-center justify-center overflow-hidden">
                  {player.avatar ? (
                    <img src={player.avatar} alt={player.nickname} width={96} height={96} className="w-full h-full object-cover" />
                  ) : (

...
import { Trophy, Star, Lock, Crown, Zap, Footprints, Hexagon, Swords, MapPin, Flame, Target, Users, Medal, Gift,  } from 'lucide-react'
import { formatArea, getAreaEquivalent } from '@/lib/citylord/area-utils'
import { ACHIEVEMENT_DEFINITIONS, type AchievementCategory, type AchievementRarity } from '@/lib/achievements'

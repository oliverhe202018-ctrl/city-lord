...
import { Trophy, Star, Zap, Shield, MapPin, Target, Crown, Moon, Sun, Footprints, Compass, Flag, Award, Medal, Flame, Droplets, Wind, Mountain, Sword, Scroll, Book, Map as MapIcon, Globe, Axe, Sunrise, Swords, Navigation } from 'lucide-react'

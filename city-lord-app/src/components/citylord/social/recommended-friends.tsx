...
import { Loader2, MapPin, Trophy, UserPlus, Check, Sparkles, Target, Zap, Search, X } from 'lucide-react'
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="relative">
                    <div
                      ...
                      onClick={() => openUserProfile(navigate, user.id, window.location.pathname + window.location.search)}
                    >
                      {user.avatar ? (

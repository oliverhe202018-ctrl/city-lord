...
import { Target, ChevronLeft, ChevronRight, Zap, Clock, CheckCircle2, MapPin, Globe, Calendar, Flame, Gift, Sparkles,  } from 'lucide-react'
import { getCityTheme, getLocalizedText, Language,  } from '@/lib/citylord/city-config'

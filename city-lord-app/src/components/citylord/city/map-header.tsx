...
import { MapPin, ChevronRight, Zap, Clock, Signal, Activity, Target, TrendingUp,  } from 'lucide-react'
import { getCityTheme, getCurrentSeason, getLocalizedText, Language,  } from '@/lib/citylord/city-config'
...
function LoginStatusPrompt() {
  ...
  return (
    <Link to="/login" className="absolute top-3 left-1/2 -translate-x-1/2 z-50">

...
import { Trophy, Star, Lock, ChevronLeft, ChevronRight, Zap, CheckCircle2, Sparkles, X,  } from 'lucide-react'
import { CityAchievement, Language, getCityTheme, getCityAchievements, getLocalizedText, getRarityColor, getRarityBgColor,  } from '@/lib/citylord/city-config'

...
import { Trophy, Target, Clock, ChevronRight, ChevronLeft, X, Zap, Star, CheckCircle2, Play, Pause, MapPin,  } from 'lucide-react'
import { CityChallenge, Language, getCityTheme, getLocalizedText, getDifficultyColor, getDifficultyBgColor,  } from '@/lib/citylord/city-config'

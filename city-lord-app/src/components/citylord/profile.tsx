    ...
    <div className="flex h-full flex-col bg-background">
      ...
      <div className="flex-1 overflow-y-auto pb-24 themed-scrollbar">
        ...
        <div className="p-4 pb-0">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link to="/profile/me" className="text-xs text-cyan-400 hover:text-cyan-300 transition-colors flex items-center gap-1">
          ...
          <div className="space-y-2">
            {loadingRuns ? (
              ...
              recentRuns.map((run) => (
                <Link to={`/run/detail?id=${run.id}`} key={run.id} className="block rounded-xl border border-border bg-card/50 p-2.5 transition-all hover:bg-card/80 active:scale-[0.99]">
        ...
        <div className="mt-auto border-t border-border bg-gray-50 dark:bg-[#0a0a0a] px-4 pt-6 pb-8">
          {/* Background Settings */}
          <Link to="/profile/backgrounds" className="flex items-center justify-between p-4 mb-3 bg-white dark:bg-gray-800/80 rounded-xl shadow-sm border border-gray-100 dark:border-white/5 active:scale-[0.98] transition-transform cursor-pointer">
            <div className="flex items-center gap-4">
          ...
          {/* My Profile Entry */}
          <Link to={`/profile/user?${new URLSearchParams({ userId, returnTo: '/profile' }).toString()}`} className="flex items-center justify-between p-4 mb-3 bg-white dark:bg-gray-800/80 rounded-xl shadow-sm border border-gray-100 dark:border-white/5 active:scale-[0.98] transition-transform cursor-pointer">
            <div className="flex items-center gap-4">
          ...
          <Link to="/referral" className="flex items-center justify-between p-4 mb-3 bg-white dark:bg-gray-800/80 rounded-xl shadow-sm border border-gray-100 dark:border-white/5 active:scale-[0.98] transition-transform cursor-pointer">
            <div className="flex items-center gap-4">
          ...
          <Link to="/feedback" className="flex items-center justify-between p-4 mb-3 bg-white dark:bg-gray-800/80 rounded-xl shadow-sm border border-gray-100 dark:border-white/5 active:scale-[0.98] transition-transform cursor-pointer">
            <div className="flex items-center gap-4">
          ...
          <Link to="/changelog" className="flex items-center justify-between p-4 mb-3 bg-white dark:bg-gray-800/80 rounded-xl shadow-sm border border-gray-100 dark:border-white/5 active:scale-[0.98] transition-transform cursor-pointer">
            <div className="flex items-center gap-4">
          ...
          <Link to="/terms" className="flex items-center justify-between p-4 mb-3 bg-white dark:bg-gray-800/80 rounded-xl shadow-sm border border-gray-100 dark:border-white/5 active:scale-[0.98] transition-transform cursor-pointer">
            <div className="flex items-center gap-4">
          ...
          <Link to="/privacy" className="flex items-center justify-between p-4 mb-3 bg-white dark:bg-gray-800/80 rounded-xl shadow-sm border border-gray-100 dark:border-white/5 active:scale-[0.98] transition-transform cursor-pointer">
            <div className="flex items-center gap-4">
          ...
          {userEmail ? (
            ...
            <Link to="/login" className="w-full p-4 mt-8 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 font-bold rounded-xl text-center active:opacity-80 transition-opacity block">
              登录账号
            </Link>
          )}

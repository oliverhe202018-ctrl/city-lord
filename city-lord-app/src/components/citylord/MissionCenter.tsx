...
import { Trophy, Hexagon, Footprints, Clock, Zap, Gift, CheckCircle2, ChevronRight, Flame, Target, Sparkles, Lock } from 'lucide-react'
    ...
    return (
      <div className="flex h-64 flex-col items-center justify-center gap-4 text-center">
        ...
        <Button asChild className="bg-[#39ff14] text-black hover:bg-[#39ff14]/90">
          <Link to="/login"><LogIn className="mr-2 h-4 w-4" /> 去登录</Link>
        </Button>
      </div>
    )
  }

...
import { getUnreadVersions, markVersionsAsRead, type UnreadVersion,  } from '@/app/actions/changelog/unread-actions'
                    ...
                    if (newRow.published_at && !oldRow.published_at) {
                        toast.info(`🎉 City Lord v${newRow.version} 新版本发布！`, {
                            ...
                            action: {
                                label: '查看更新',
                                onClick: () => {
                                    navigate(`/changelog/${newRow.version}`)
                                },
                            },
                        })
                        // 刷新未读计数

...
export function AccessDenied({ userId, error }: AccessDeniedProps) {
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center bg-background p-4 text-center">
      ...
      {(userId || error) && (
        <div className="mb-8 p-4 bg-muted rounded-lg text-left text-xs font-mono max-w-[600px] overflow-auto">
          <p className="font-bold text-destructive mb-2">Debug Info:</p>

filepath = r"g:\city-lord-game-interface\city-lord-game-interface\hooks\useMissions.ts"

full_reconstructed = """\"use client\"
...
with open(filepath, 'w', encoding='utf-8') as f:
    f.write(full_reconstructed)

print("File reconstructed successfully from scratch.")
